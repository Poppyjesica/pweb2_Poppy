...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset ('skydash/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}"
    />
    <link rel="stylesheet" href="{{ asset ('skydash/vendors/ti-icons/css/themify-icons.css') }}" />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset ('skydash/js/select.dataTables.min.css') }}"
    />
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        >
          <a class="navbar-brand brand-logo mr-5" href="index.html"
            ><img src="{{ asset ('skydash/images/logo.svg')}}" class="mr-2" alt="logo"
          /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"
            ><img src="{{ asset ('skydash/images/logo.jpg')}}" alt="logo"
          /></a>
        </div>
        <div
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            >
              ...
              <ul class="chat-list">
                <li class="list active">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face1.jpg')}}" alt="image" /><span
                      class="online"
                    ></span>
                  </div>
                  <div class="info">
                ...
                <li class="list">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face2.jpg')}}" alt="image" /><span
                      class="offline"
                    ></span>
                  </div>
                  <div class="info">
                ...
                <li class="list">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face3.jpg')}}" alt="image" /><span
                      class="online"
                    ></span>
                  </div>
                  <div class="info">
                ...
                <li class="list">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face4.jpg')}}" alt="image" /><span
                      class="offline"
                    ></span>
                  </div>
                  <div class="info">
                ...
                <li class="list">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face5.jpg')}}" alt="image" /><span
                      class="online"
                    ></span>
                  </div>
                  <div class="info">
                ...
                <li class="list">
                  <div class="profile">
                    <img src="{{ asset ('skydash/images/faces/face6.jpg')}}" alt="image" /><span
                      class="online"
                    ></span>
                  </div>
                  <div class="info">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
              ...
              <div class="col-md-12 grid-margin">
                <div class="row">
                  <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Selamat Datang di Website</h3>
                    ...
                    <div class="justify-content-end d-flex">
                      <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                        <button
                          ...
                          aria-expanded="true"
                        >
                          <i class="mdi mdi-calendar"></i> Kamis (6 April 2023)
                        </button>
                        <div
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card tale-bg">
                  <div class="card-people mt-auto">
                    <img src="{{ asset ('skydash/images/dashboard/people.png')}}" alt="people" />
                ...
                <div class="row">
                  <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-tale">
                      <div class="card-body">
                        <p class="mb-4">Permintaan</p>
                        <p class="fs-30 mb-2">10</p>
                        <p>Jumlah Permintaan Konsumen</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-dark-blue">
                      <div class="card-body">
                        <p class="mb-4">Gas 3kg</p>
                        <p class="fs-30 mb-2">100 PCS</p>
                        <p>Jumlah Stok Gas 3 kg</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6 stretch-card transparent">
                    <div class="card card-light-danger">
                      <div class="card-body">
                        <p class="mb-4">Barang yang Terjual</p>
                        <p class="f s-30 mb-2">90 PCS</p>
                        <p>Jumlah gas lpg yang terjual</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-12 width-5 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <p class="card-title">Tentang Pangkalan Pepy Gas</p>
                    <p class="font-weight-500">
                     Pangkalan ini adalah agen gas elpiji (LPG) untuk masyarakat yang ingin 
                     menjadi distributor resmi untuk dipasarkan kepada warga. Kemudian pangkalan ini berdiri sejak tahun 1990. 
                     Pangkalan Pepy gas ini sudah banyak dipercaya oleh para konsumen. Selain itu maaf jika banyak yang order ada yang kita cancel dulu.
                    </p>
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <p class="card-title mb-0">Pesanan Barang</p>
                    ...
                    <ul class="icon-data-list">
                      <li>
                        <div class="d-flex">
                          ...
                          <div>
                            <p class="text-info mb-1">Radian</p>
                            <p class="mb-0">Apa yang bisa kami bantu kak!</p>
                            <small>9:30 am</small>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="d-flex">
                          ...
                          <div>
                            <p class="text-info mb-1">Muslimah</p>
                            <p class="mb-0">
                              Pesanan telah sampai ketujuan ya kak!
                            </p>
                      ...
                      <li>
                        <div class="d-flex">
                          ...
                          <div>
                            <p class="text-info mb-1">Abi</p>
                            <p class="mb-0">
                              Ditunggu pesanan untuk selanjutnya ya kak!
                            </p>
                      ...
                      <li>
                        <div class="d-flex">
                          ...
                          <div>
                            <p class="text-info mb-1">Mini</p>
                            <p class="mb-0">
                              Mohon bersabar sedang dalam perjalanan!
                            </p>
                            <small>8:50 am</small>
                          </div>
                        </div>
                      ...
                      <li>
                        <div class="d-flex">
                          ...
                          <div>
                            <p class="text-info mb-1">Asiah</p>
          ...
          <footer class="footer">
            ...
            >
              <span
                ...
                >Copyright © 2023. Pangkalan Pepy Gas 
